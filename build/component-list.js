...
module.exports = {
  ViChart: { src: 'src/packages/chart/index.js', dist: 'lib/chart/index' },
  ViLine: { src: 'src/packages/line/index.js', dist: 'lib/line/index' },
  ...
  // ViRadar: { src: 'src/packages/radar/index.js', dist: 'lib/radar' },
  // ViGauge: { src: 'src/packages/gauge/index.js', dist: 'lib/gauge' },
  //
  ...
  // ViSankey: { src: 'src/packages/sankey/index.js', dist: 'lib/sankey' },
  // Viheatmap: { src: 'src/packages/heatmap/index.js', dist: 'lib/heatmap' },
  // ViCandle: { src: 'src/packages/candle/index.js', dist: 'lib/candle' },
  // ViTree: { src: 'src/packages/tree/index.js', dist: 'lib/tree' },
  // ViLiquidfill: { src: 'src/packages/liquidfill/index.js', dist: 'lib/liquidfill' },
  // ViWordcloud: { src: 'src/packages/wordcloud/index.js', dist: 'lib/wordcloud' }
}
